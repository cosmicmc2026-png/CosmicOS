...
/// Restituisce i glyph bytes per il carattere ASCII `c`.
/// Ritorna un glyph vuoto per caratteri fuori range.
#[inline]
...
/// Font 8×8, 95 caratteri, ASCII 0x20–0x7E
pub static FONT_8X8: [[u8; 8]; 95] = [
    ...
    // 0x25 '%'
    [0xC6, 0xCC, 0x18, 0x30, 0x60, 0xCC, 0x86, 0x00],
    // 0x26 '&'
